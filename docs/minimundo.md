...
O sistema representa a operacao de uma rede de petshops focada em cuidados e atendimento a animais domesticos. O objetivo e registrar lojas, clientes, funcionarios, pets, atendimentos, servicos executados e o historico de relacionamento entre esses elementos.
...
- O cliente pode agendar atendimentos pelo site.
- Quando o atendimento ocorrer presencialmente, o funcionario responsavel registrara o servico no sistema para manter o historico.
...
- Um usuario pode ser diferentes tipos de conta, mas elas precisam de emails diferentes.
...
- O funcionario pode nao estar associado a uma loja, considerando o periodo de alocacao deste.

## Gestao de lojas e perfis administrativos

Perfis de acesso:

- super_admin: administra a rede toda, pode criar lojas e cadastrar admins de loja.
- admin_loja: administra somente uma unidade especifica, mas tem controle sobre as informacoes dela.
